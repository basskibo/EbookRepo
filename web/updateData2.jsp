...
<jsp:useBean id="user"
	type="rs.ac.uns.ftn.informatika.RS13.IspitniProjekat.server.entity.User"
		...
		<div class="container">
			...
			<form action="./UpdateControllerKorisnik" method="post"
				...
				<div class="input-group">
					...
					<span class="input-group-addon">Last Name</span> <input type="text"
						name="lName" class="form-control" value="${user.lastName}"
						required>
				</div>
				<div class="input-group">
				...
				<input type="hidden" name="userID" value="${user.userID}"> <input
					type="hidden" name="tLozinka" value="${user.userPassword}">

				<p>
					If you want to change your password follow this <a
						href="./PrepareUpdateKorisnikLozinka "> <span class="crveno">link.</span></a>
				</p>
				...
				<span onClick="check();" class="setType" style="cursor: pointer;"
					id="setUser">Set type of User</span>
				<h5>
					If you choose Subscriber you <span class="crveno">MUST</span> click
					on the <q>Set type of User</q>button to choose from categories.
				</h5>

				<button class="dugme" id="submit" type="submit" class="btn-success"
					style="width: 90px; float: right;">Submit</button>
