	...
	<div class="jumbotron">
		<div class="container">
			...
			<div class="page-header">
				<h1>Users list</h1>
				<p class="lead">Here you can see list of all users.You can also
					add new user or edit/delete existing user.</p>
			</div>
			<table>
				<tr>
					<div class="row">
						...
						<div class="row">
							...
							<c:if test="${sessionScope.admin!=null}">
								<div id="rowBook" class="col-md-2">
									<a class="btnAR"
										href="./PrepareUpdateUser2?userID=${user.userID }">Edit</a> <a
										class="btnAR"
										href="./DeleteControllerKorisnik?userID=${user.userID}">Remove</a>
			...
			<button type="button" class="btn btn-info btn-lg" data-toggle="modal"
				data-target="#newCategory">Create new User</button>
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<c:if test="${sessionScope.admin!=null}">
								<h2>Add new User</h2>
								<form action="./CreateControllerKorisnik" method="post"
									accept-charset="ISO-8859-1" onsubmit="return checkForm(this);">
									<c:if test="${sessionScope.admin !=null}">
										...
										<div class="input-group">
											...
											<span class="input-group-addon">Last Name</span> <input
												type="text" name="lName" class="form-control" required>
										</div>
										<div class="input-group">
										...
										<div class="input-group">
											<span class="input-group-addon">Password again</span> <input
												type="password" name="userPassword2" class="form-control"
												required>
										</div>
										...
										<div class="input-group" id="tipDiv">
											...
											<c:forEach items="${category}" var="cat">
												<p class="hidden" id="Allcats">${cat.name }</p>
											</c:forEach>
											...
											<script>
												function check() {
													...
													if (strUser == 'subscriber') {
														...
														theContainer
																.appendChild(theSelect);
														document
																.getElementById('setUser').style.visibility = 'hidden';
														document
																.getElementById('admin').style.visibility = 'hidden';
										...
										<span onClick="check();" class="setType"
											style="cursor: pointer;" id="setUser">Set type of User</span>
										<h5>
											If you choose Subscriber you <span class="crveno">MUST</span>
											click on the <q>Set type of User</q>button to choose from
											categories.
										</h5>
