	...
	<c:if test="${sessionScope.administrator != null}">
		...
		<div class="jumbotron">
			<div class="container">
				...
				<p>
					<a class="btn btn-primary btn-lg" href="./ReadControllerEbooks"
						role="button">Find your book &raquo;</a>
				</p>
			</div>
		</div>
	...
	<c:if
		...
		<div class="jumbotron">
			<div class="container">
				...
				<p>Here you can find variety of books in pdf format.If you want
					to be able to download you have to log in as our subscribed
					user.You can subscribe to all of our categories or you can just
					subscribe to one category.It's your choice,find more,search
					better..</p>
				<p>
					<a class="btn btn-primary btn-lg" href="./ReadControllerEbooks"
						role="button">Find your book &raquo;</a>
			...
			<ul class="slides">
				...
				<li class="slide-container">
					<div class="slide">
						<img
							src="https://teamnoname.files.wordpress.com/2011/02/pdf_cover.jpg" />
					</div>
					<div class="nav">
				...
				<li class="slide-container">
					<div class="slide">
						<img
							src="http://tamarasaviano.com/wp-content/uploads/2013/09/From-Art-to-Commerce-ebook-PDF-cover-590x763.jpg" />
					</div>
					<div class="nav">
