...
<jsp:useBean id="category" type="rs.ac.uns.ftn.informatika.RS13.IspitniProjekat.server.entity.Category" scope="request"/>
			  ...
			  <div class="modal-dialog">
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
						<c:if test="${sessionScope.admin!=null}">
				    		<form action="./UpdateControllerCategory" method="post" accept-charset="ISO-8859-1" >
