								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									...
									<ul class="dropdown-menu">
										...
										<c:forEach items="${category}" var="cat">
											<li><a
												href="./FindCategoryBooks?category_id=${cat.categoryID }">${cat.name}</a></li>
										</c:forEach>
						...
						<div id="navbar" class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									...
									<ul class="dropdown-menu">
										<li><a href="./PrepareReadControllerCategory">Change
												Password</a></li>
		...
		<div class="container">
			...
			<div class="page-header">
				...
				<form action="./FindCategory" method="get"
					...
					<select size="1" style="height: 35px; width: 30%;"
						name="categorySelect">
						<c:forEach items="${category}" var="cat">
							<option value="${cat.name}">${cat.name}</option>
						</c:forEach>
					</select>
					<button class="dugme" id="submit" type="submit" class="btn-success"
					...
					<c:if test="${sessionScope.administrator == true}">
						...
						<button type="button" class="btn btn-info btn-lg"
							data-toggle="modal" data-target="#newUser">Create new
							Book</button>
					</c:if>
				</form>
				...
				<table>
					<tr>
						<div class="row">
							<c:if
								test="${sessionScope.admin == null && sessionScope.subscriber == null}">
							...
							<c:if test="${sessionScope.administrator != null}">
								<div id="rowTitle" class="col-md-2">Change</div>
							</c:if>
							<c:if test="${sessionScope.subscriber != null }">
								<div id="rowTitle" class="col-md-2">Download</div>
							</c:if>
						...
						<tr>
							<div class="row">
								...
								<c:if test="${sessionScope.administrator != null}">
									<div id="rowBook" class="col-md-2">
										<a class="btnAR"
											href="./PrepareUpdateEbook?ebook_id=${ebook.id }">Edit</a> <a
											class="btnAR"
											href="./DeleteControllerEbook?ebook_id=${ebook.id }">Delete</a>
									</div>
								</c:if>

								<c:if test="${sessionScope.subscriber != null }">
									<c:if
										test="${sessionScope.category == ebook.category.categoryID }">
										<div id="rowBook" class="col-md-2">
											<a class="btnAr" href="#">Download</a>
										</div>
									</c:if>
									<c:if
										test="${sessionScope.category != ebook.category.categoryID && sessionScope.allCategory == null }">
										<div id="rowBook" class="col-md-2">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<c:if test="${sessionScope.admin!=null}">
									...
									<form action="./CreateControllerEbook" method="post"
										accept-charset="ISO-8859-1">
										<!-- 	    									onsubmit="return checkForm(this);"
 -->
										<c:if test="${sessionScope.admin !=null}">
											<div class="input-group">
												<span class="input-group-addon">Upload File</span> <input
													type="file" name="filename" accept=".pdf"
													class="form-control">
											...
											<div class="input-group">
												...
												<span class="input-group-addon">Author</span> <input
													type="text" name="author" class="form-control" required>
											</div>


											<div class="input-group">
												<span class="input-group-addon">Year</span> <input
													type="number" name="year" class="form-control" required>
											</div>
											<div class="input-group" id=",">
												<span class="input-group-addon">Category</span> <select
													size="1" style="height: 35px;" class="form-control"
													name="categorySelect">
													<c:forEach items="${category}" var="cat">
											...
											<div class="input-group" id="4">
												<span class="input-group-addon">Mime-Type</span> <select
													size="1" class="form-control" style="height: 35px;"
													name="mimeSelect">
											...
											<div class="input-group" id="l">
												<span class="input-group-addon">Language</span> <select
													size="1" style="height: 35px;" class="form-control"
													name="langSelect">
											...
											<script type="text/javascript">
												function checkForm(form) {
													...
													if (form.userPassword.value != ""
															&& form.userPassword.value == form.userPassword2.value) {
