...
<jsp:useBean id="ebook" type="rs.ac.uns.ftn.informatika.RS13.IspitniProjekat.server.entity.Ebook" scope="request"></jsp:useBean>
...
<!-- 	    									onsubmit="return checkForm(this);"
 -->					        		<c:if test="${sessionScope.admin !=null}">
								                	...
								                	<div class="input-group">
									    				...
									    				<input type="text" class="form-control" value="${ebook.title }" name="title" required>
							  						</div>
							  						<div class="input-group">
							  					
									    				<span  class="input-group-addon">Author</span>
									    				<input type="text"   name= "author" value="${ebook.author }" class="form-control" required>
								    				</div>
								    				 <div class="input-group">
								    				
									    				<span class="input-group-addon">Filename</span>
									    				<input type="file" class="form-control" value="${ebook.filename }" name="filename">
									    			</div>
									               						    												                
								    			<div class="input-group">
								    				<span  class="input-group-addon">Year</span>
								    				<input type="number"   name= "year" class="form-control" value="${ebook.year }" required>
							  					</div>
