				...
				<c:if test="${sessionScope.admin !=null}">
					...
					<div class="input-group">
						<span class="input-group-addon">First Name</span> <input
							...
							value="${sessionScope.admin.firstName}" required>
					</div>
					<div class="input-group">

						<span class="input-group-addon">Last Name</span> <input
							type="text" name="lName" class="form-control"
							value="${sessionScope.admin.lastName}" required>
					</div>
					<div class="input-group">
						<span class="input-group-addon">Username</span> <input type="text"
							class="form-control" name="username"
							value="${sessionScope.admin.username}" required>
					</div>
					<input type="hidden" name="userID"
						value="${sessionScope.admin.userID}">
					<input type="hidden" name="tLozinka"
						value="${sessionScope.admin.userPassword}">
