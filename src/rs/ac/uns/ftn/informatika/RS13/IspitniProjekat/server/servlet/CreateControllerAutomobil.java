...
public class CreateControllerAutomobil extends HttpServlet {
	
	private static final long serialVersionUID = -123124112L;
	private static Logger log = Logger.getLogger(CreateControllerAutomobil.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if((request.getParameter("menjac").equalsIgnoreCase("Manuelni")) ){
				menjac ="Manuelni";
			}
			if((request.getParameter("menjac").equalsIgnoreCase("Automatski"))){
				menjac= "Automatski";
			}
