...
public class ReadControllerModeli extends HttpServlet {
	

	private static final long serialVersionUID = -123124111112L;
	private static Logger log = Logger.getLogger(ReadControllerModeli.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*try{
			...
			request.setAttribute("modeli", modelDao.findByProizvodjac(proizvodjacId));
